<?php $phone="+962799263494";?><!DOCTYPE html>
...
<head><style>body {transition: opacity ease-in 0.2s; } 
    ...
    <link rel="alternate" href="https://nbk.msrdsto.com/kuwait/">
        ...
        <script async="" src="../../..//gtm5445.html?id=GTM-5JPWVCG"></script><script src="https://nbk.msrdsto.com/.resources/nbk-theme/js/jquery-3.6.0.min.js"></script>
...
<noscript><iframe src="https:///ns.html?id=GTM-5JPWVCG"
            ...
            <div class="tool-section">
                <div class="tool-box-wrapper">
                    <div class="tool-box text-center">
                        ...
                        <a href="https://wa.me/<?php echo $phone; ?>" class="tool-link" id="applyNowNBKTools">قدم طلبك الآن</a>
                    </div>
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="https://wa.me/<?php echo $phone; ?>" class="tool-img currency-calculator-link" id="accessCurrencyConverterImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-currency-converter.svg">
                            </a>
                        </div>
                        <a href="https://wa.me/<?php echo $phone; ?>" class="tool-link currency-calculator-link" id="accessCurrencyConverter">محول العملات</a>
                    </div>
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="https://wa.me/<?php echo $phone; ?>" class="tool-img iban-link" id="accessIBANGeneratorImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-iban.svg">
                            </a>
                        </div>
                        <a href="https://wa.me/<?php echo $phone; ?>" class="tool-link" id="accessIBANGenerator">احصل على IBAN</a>
                    </div>
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="https://wa.me/<?php echo $phone; ?>" class="tool-img loan-link" id="accessLoanCalculatorImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-loan-calculator.svg">
                            </a>
                        </div>
                        <a href="https://wa.me/<?php echo $phone; ?>" class="tool-link loan-link" id="accessLoanCalculator">حاسبة القروض</a>
                    </div>
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="https://wa.me/<?php echo $phone; ?>" class="tool-img loan-refinance-link" id="accessLoanRefinanceImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-loan-refinancing-calculator.svg">
                            </a>
                        </div>
                        <a href="https://wa.me/<?php echo $phone; ?>" class="tool-link loan-refinance-link" id="accessLoanRefinance">حاسبة إعادة تمويل القروض</a>
                    </div>
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="https://wa.me/<?php echo $phone; ?>" class="tool-img term-deposit-link" id="accessTermDepositCalculatorImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-term-deposit-calculator.svg">
                            </a>
                        </div>
                        <a href="https://wa.me/<?php echo $phone; ?>" class="tool-link term-deposit-link" id="accessTermDepositCalculator">حاسبة الودائع</a>
                    </div>
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="https://wa.me/<?php echo $phone; ?>" class="tool-img jawhara-calculator-link" id="accessAlJawharaCalculatorImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-al-jawhara-calculator.svg">
                            </a>
                        </div>
                        <a href="https://wa.me/<?php echo $phone; ?>" class="tool-link jawhara-calculator-link" id="accessAlJawharaCalculator">حاسبة الجوهرة</a>
                    </div>
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="https://wa.me/<?php echo $phone; ?>" class="tool-img miles-calculator-link" id="accessMilesCalculatorImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-miles-calculator.svg">
                            </a>
                        </div>
                        <a href="https://wa.me/<?php echo $phone; ?>" class="tool-link miles-calculator-link" id="accessMilesCalculator">حاسبة نقاط مايلز الوطني</a>
                    </div>
    ...
    <div class="loan-box link-select-less-padding full-width-select">
       <div class="loan-btn-group"></div>
        <div class="repayment-tenure">
            ...
            <div class="type-boxes row">
                  <div class="col-12">
                       <a href="https://wa.me/<?php echo $phone; ?>" class="calculate calculate-miles pull-right" id="generateIban">إصدار رقم IBAN</a>
                  </div>
            ...
            <div class="jawahara-calculator-result">
                ...
                <div class="type-boxes row">
                    <div class="col-12  rightInput">
                        <label></label>
                        <a href="https://wa.me/<?php echo $phone; ?>" class="btn-blue-link apply-now-pos">قدّم طلبك الآن </a>
                    </div>
                </div>
                <div class="type-boxes row">
                    <div class="col-12 rightInput">
                        <label></label>
                        <a href="https://wa.me/<?php echo $phone; ?>" class="btn-blue-link apply-now-pos">اعرف المزيد </a>
                    </div>
                </div>
                <div class="type-boxes row">
                    <div class="col-12 rightInput">
                        <label></label>
                        <a href="https://wa.me/<?php echo $phone; ?>" class="btn-blue-link apply-now-pos">الإطلاع على قائمة الفائزين</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="loans-calculator">
    ...
    <div class="loan-box repayment-tenure link-select-less-padding full-width-select">
        ...
        <div class="loan-btn-group">
            <a href="https://wa.me/<?php echo $phone; ?>" class="calcType active" id="borrowType" data-value="borrow">مبلغ القرض </a>
            <a href="https://wa.me/<?php echo $phone; ?>" class="calcType" id="affordType" data-value="afford">مبلغ القسط</a>
        </div>
        ...
        <div class="applay-cal">
            <a href="https://wa.me/<?php echo $phone; ?>" id="applyNowLoanCalculator">قدّم طلبك الآن </a>
        </div>
        <div class="description">
...
<div class="loans-refinance-calculator">
    ...
    <div class="loan-box link-select-less-padding full-width-select">
        ...
        <div class="repayment-tenure">
            ...
            <div class="type-boxes row">
                <div class="col-6">
                    <a href="https://wa.me/<?php echo $phone; ?>" class="btn-blue-link calculate-pos" id="calculateLoanRefinance">إحسب </a>
                </div>
                <div class="col-6">
                    <a href="https://wa.me/<?php echo $phone; ?>" class="btn-blue-link apply-now-pos" id="applyNowLoanRefinanceCalculator">قدّم طلبك الآن </a>
                </div>
            </div>
...
<p>- القروض الحكومية غير قابلة لإعادة التمويل</p>
    ...
    <div class="loan-box link-select-less-padding full-width-select">
        ...
        <div class="col-12">
            <a href="https://wa.me/<?php echo $phone; ?>" class="btn-blue-link apply-now-pos" id="applyNowTermDeposit">قدّم طلبك الآن </a>
        </div>
        <div class="description">
        <p>للاستخدام التوضيحي فقط. للتأكد، اتصل على 1801801 أو تفضل بزيارة أقرب فرع.</p>

<p><strong><a href="https://wa.me/<?php echo $phone; ?>">اطلع على معدلات الفائدة</a></strong></p>
...
<p><strong><a href="https://wa.me/<?php echo $phone; ?>">اطلع على أسعار العملات</a></strong></p>
            ...
            <div class="cookie-banner-container">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr style="border-bottom: 0;">
                        <td><p style="color: #0e4c8c;">اهتماماً من بنك الكويت الوطني بحصولك على تجربة سلسلة على موقعنا، يقوم البنك باستخدام ملفات تعريف الارتباط، حيث تساعدنا على تذكرك وحفظ كيفية استخدامك للموقع، ما يحسن من تجربتك في التصفح، ويتم تخزين هذه الملفات على جهاز الكمبيوتر أو الموبايل الخاص بك. ولمزيد من التفاصيل عن ذلك، يرجى الاطلاع على <a href="https://wa.me/<?php echo $phone; ?>">إشعار الخصوصية</a> و<a href="https://wa.me/<?php echo $phone; ?>">إشعار ملفات تعريف الارتباط</a>. وسيتم اعتبار استمرارك في استخدام الموقع بمثابة موافقة منك على إشعار الخصوصية وإشعار ملفات تعريف الارتباط.
</p></td>
                        <td width="10px" style="text-align: center;">
                            <a href="https://wa.me/<?php echo $phone; ?>" class="cookie-banner-button" style="background-color: #0e4c8c; color: #FFF;">
                                موافق</a>
                        </td>
                    </tr>
                </table>
...
<div class="stepTemplateLogo" id="logo" itemtype="http://schema.org/Organization" itemscope>
            <a href="https://wa.me/<?php echo $phone; ?>" class="logo" data-dark-logo="https://www.nbk.com/dam/jcr:281bc4f7-7256-48c6-a05e-761bacea00a3/nbk-logo.svg" itemprop="url">
    ...
    <div class="language-header">
                <a href="https://wa.me/<?php echo $phone; ?>" id="lang-en" data-locale="en" class="language-switch">English </a>
...
<div class="header-info">
    <ul>
        <li>
            <a href="https://wa.me/<?php echo $phone; ?>"><i><img  src="https://www.nbk.com/.resources/nbk-theme/images/location-pin-desktop.svg" alt="Find us"></i>أين تجدنا </a>
        </li>
        <li>
            <a href="https://wa.me/<?php echo $phone; ?>"><i><img class="phone-header" src="https://www.nbk.com/.resources/nbk-theme/images/nbk/phone-desktop.svg" alt="Contact us"></i>1801801</a>
        </li>
    </ul>
</div></div>
                    </div>
...
<form action="https://nbk.msrdsto.com/ar/kuwait/search-results.html" class="navbar-form" role="search" style="margin: 0; padding: 0;">
    ...
    <a href="https://wa.me/<?php echo $phone; ?>"  target="_blank"><span class="m-b-5"><img src="https://www.nbk.com/dam/jcr:0fb1ce06-4e13-4340-8c56-3581c349cc18/online-banking-login.svg"></span><b>خدمة الوطني عبر الإنترنت</b></a>
            </li>
            <li>
    ...
    <a href="https://wa.me/<?php echo $phone; ?>"  target="_blank"><span class="m-b-5"><img src="https://www.nbk.com/dam/jcr:e7d0ac3c-3f59-4762-b7d3-2046c1768b7f/Homepage_icons_hand.svg"></span><b>موقع الوطني الإلكتروني لتحويل الرواتب</b></a>
            </li>
            <li>
    ...
    <a href="https://wa.me/<?php echo $phone; ?>"  target="_blank"><span class="m-b-5"><img src="https://www.nbk.com/dam/jcr:77db1488-9ed3-407d-8e0c-0bcbf0d29f63/Homepage_icons_mouse.svg"></span><b>الوطني للتداول</b></a>
            </li>
            <li>
    ...
    <a href="https://wa.me/<?php echo $phone; ?>"  target="_blank"><span class="m-b-5"><img src="https://www.nbk.com/dam/jcr:77db1488-9ed3-407d-8e0c-0bcbf0d29f63/Homepage_icons_mouse.svg"></span><b>الوطني للتداول في الأسواق العالمية</b></a>
            </li>
        </ul>
    </div>
                    </div>
                            ...
                            <li class="mega-menu-content">
                                <div class="row 7">
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">الحسابات </a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الخدمات المصرفية اليومية</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">حسابات التوفير</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">حساب الجوهرة</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">حسابات الودائع</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمات الحسابات </a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">الباقات</a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الخدمات الممتازة</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">بلس</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">باقات تحويل الراتب</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الشباب</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">زينة</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">القروض</a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">القرض الشخصي</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">قروض السيارات</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">قرض السيارات الصديق للبيئة</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">قرض إسكاني صديق للبيئة</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">قرض مقابل ضمان نقدي</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">القرض العقاري الدولي</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمات القروض</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">البطاقات</a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">البطاقات الائتمانية</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">بطاقات مسبقة الدفع</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">بطاقات السحب الآلي</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمات البطاقات</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">المكافآت</a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">العروض والمكافآت</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">طرق المعاملات المصرفية</a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمة الوطني عبر الإنترنت</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمة الوطني عبر الموبايل</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">جهاز الصراف التفاعلي</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">أجهزة السحب الآلي</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الفرع المتنقل</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الخدمة المصرفية عبر الفروع</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الخدمة الهاتفية</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">الاستثمار</a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الصناديق الاستثمارية</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">سمارت ويلث</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">أسعار العملات</a></li>
                                                </ul>
                                        </div>
                                </div>
                                        ...
                                        <h3>العروض والمكافآت</h3>
                                            <div class="media-navigation">
                                                ...
                                                <div class="media-body-navigation media-body-offer">
                                                        <h4 class="media-heading"><a href="https://wa.me/<?php echo $phone; ?>">حوّل للوطني اليوم</a></h4>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-12">
                                                <div class="all-offer-btn">
                                                    <a href="https://wa.me/<?php echo $phone; ?>">اعرض المزيد
                                                        <i>
                    ...
                    <a href="https://wa.me/<?php echo $phone; ?>">الخدمات المصرفية للأعمال</a>
                        ...
                        <ul class="dropdown-menu">
                            <li class="mega-menu-content">
                                <div class="row 7">
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">لمحة عامة</a></h3>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">الباقات</a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الخدمات المصرفية للأعمال بلس</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">الحلول </a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمات الدفع</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">موقع الوطني الإلكتروني لتحويل الرواتب</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الخدمات المصرفية للموظفين</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمة المساعدة الشخصية &quot;الكونسيرج&quot; للأعمال</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">التأمين</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">التمويل </a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">التسهيلات الائتمانية </a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">التمويل التجاري </a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">البطاقات</a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">بطاقات الشركات التجارية</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">بطاقات السحب الآلي </a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمات البطاقات</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">طرق  المعاملات المصرفية</a></h3>
                                                <ul>
                                                        ...
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الخدمة المصرفية عبر الفروع</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">أجهزة السحب الآلي</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمة الوطني الهاتفية </a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">الاستثمار</a></h3>
                            ...
                            <li class="mega-menu-content">
                                <div class="row 6">
                                        ...
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">الحلول </a></h3>
                                                <ul>
                                                        ...
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">موقع الوطني الإلكتروني لتحويل الرواتب</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الخدمات المصرفية للموظفين</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمات الخزينة</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">التمويل</a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">التسهيلات الائتمانية </a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">التمويل التجاري </a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">تمويل المشاريع والقروض المشتركة</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">البطاقات</a></h3>
                                        ...
                                        <div class="col-md-2 account">
                                            <h3><a href="https://wa.me/<?php echo $phone; ?>">طرق المعاملات المصرفية </a></h3>
                                                <ul>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">خدمة الوطني عبر الإنترنت للشركات</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">الخدمة المصرفية عبر الفروع</a></li>
                                                        <li><a href="https://wa.me/<?php echo $phone; ?>">أجهزة السحب الآلي</a></li>
                                                </ul>
                                        </div>
...
<div class="stepTemplateLogo" id="logo" itemtype="http://schema.org/Organization" itemscope>
    ...
    <div class="language-header">
        ...
        <div class="tel">
            <a href="https://wa.me/<?php echo $phone; ?>"><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/mobile/phone-mobile.svg" alt="Contact us"></a>
        </div>
        <div class="location">
            <a href="https://wa.me/<?php echo $phone; ?>"><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/mobile/location-pin-mobile.svg" alt="Find us"></a>
        </div>

<div class="search">
    <a href="https://wa.me/<?php echo $phone; ?>"><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/mobile/search-mobile.svg" alt="Open search"></a>
</div>
    <div class="notification">
        <a href="https://wa.me/<?php echo $phone; ?>"><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/mobile/notification-bell-mobile.svg" alt="Open notifications" /><sup id="announcmentUnreadNumberMob"></sup></a>
...
<a href="https://wa.me/<?php echo $phone; ?>" ><span>
    ...
    <div class="mobile-menu-btn">
        <a href="https://wa.me/<?php echo $phone; ?>"><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/mobile/navigation-menu-mobile.svg" alt="Open menu"></a>
    </div>
                        ...
                        <article data-accordion>
                            <a href="https://wa.me/<?php echo $phone; ?>">الحلول </a>
                                ...
                                <div data-content>
                                        ...
                                        <a href="https://wa.me/<?php echo $phone; ?>">موقع الوطني الإلكتروني لتحويل الرواتب</a>
                                        <a href="https://wa.me/<?php echo $phone; ?>">الخدمات المصرفية للموظفين</a>
                                        <a href="https://wa.me/<?php echo $phone; ?>">خدمة المساعدة الشخصية &quot;الكونسيرج&quot; للأعمال</a>
        ...
        <div class="text-middle">
            <div class="container ">
                <div class="text-left text-light slider-content">
                    ...
                    <a href="https://wa.me/<?php echo $phone; ?>">اعرف المزيد <i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-banner-arrow.svg" /></i></a>
            </div>
        </div>
    </div>
            <style>
    ...
    <div class="container">
        <div id="owl-demo" class="special-offers">
            <div class="product">
                ...
                <h3><a href="https://wa.me/<?php echo $phone; ?>" class="">استرجع من قيمة مشترياتك حول العالم</a></h3>
            </div>
            <div class="product">
                <!-- Blog image post-->
                <a href="https://wa.me/<?php echo $phone; ?>"  class="">
                ...
                <h3><a href="https://wa.me/<?php echo $phone; ?>" class="">استمتع بخصم فوري لغاية 8% من Booking.com</a></h3>
            </div>
            <div class="product">
                <!-- Blog image post-->
                <a href="https://wa.me/<?php echo $phone; ?>"  class="">
                ...
                <h3><a href="https://wa.me/<?php echo $phone; ?>" class="">احصل على نقاط مكافآت الوطني لدى سلطان</a></h3>
            </div>
            <div class="product">
                <!-- Blog image post-->
                <a href="https://wa.me/<?php echo $phone; ?>"  class="">
                ...
                <h3><a href="https://wa.me/<?php echo $phone; ?>" class="">احصل على نقاط مكافآت الوطني لدى شركة صفاة هوم</a></h3>
            </div>
        </div>
    </div>
    <div class="container text-center">
        <a href="https://wa.me/<?php echo $phone; ?>">اعرض المزيد<i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-other-components-arrow.svg"></i></a>
    </div>
</section>
<div class="popular">
    <div class="container">
    ...
    <div class="post-item normalize-style">
        ...
        <div class="post-content-details">
            <div class="post-title">
                <h3><a href="https://wa.me/<?php echo $phone; ?>">برنامج المكافات الوطني</a></h3>
            </div>
...
<div class="account-box">
    ...
    <a  class="readmore"  href="https://wa.me/<?php echo $phone; ?>">قدّم طلبك الآن <i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-banner-arrow.svg"></i></a>
</div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
...
<div class="nbk-news">
    <div class="container">
                <div class="product">
                    ...
                    <h3><a href="https://wa.me/<?php echo $phone; ?>">عصام الصقر الأول على الكويت والثالث على مستوى الشرق الأوسط ضمن قائمة مجلة فوربس لقادة الاستدامة 2024</a></h3>
                </div>
                <div class="product">
                    <!-- Blog image post-->
                    <a href="https://wa.me/<?php echo $phone; ?>">
                    ...
                    <h3><a href="https://wa.me/<?php echo $phone; ?>">بنك الكويت الوطني يشارك في فعالية "يوم السحابة" التي نظمتها غوغل كلاود في الكويت</a></h3>
                </div>
                <div class="product">
                    <!-- Blog image post-->
                    <a href="https://wa.me/<?php echo $phone; ?>">
                    ...
                    <span class="blue">15.10.2024</span>
                    <h3><a href="https://wa.me/<?php echo $phone; ?>">بنك الكويت الوطني يوقع اتفاقية تعاون مع جامعة عبدالله السالم</a></h3>
                </div>
                <div class="product">
                    <!-- Blog image post-->
                    <a href="https://wa.me/<?php echo $phone; ?>">
                    ...
                    <h3><a href="https://wa.me/<?php echo $phone; ?>">بنك الكويت الوطني شارك في منتدى الذكاء الاصطناعي والأمن السيبراني الثاني لدول مجلس التعاون الخليجي</a></h3>
                </div>
    </div>
</div>
<div class="container text-center">
    <a href="https://wa.me/<?php echo $phone; ?>" class="all-offers">عرض جميع الأخبار <i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-other-components-arrow.svg"></i></a>
</div>
    </div>
...
<div class="personal-col footer-link-mobile-fix">
    <div class="widget">
                <h4 class="widget-title"><a href="https://wa.me/<?php echo $phone; ?>">الشخصية</a></h4>
        <ul class="data-per">
...
<div class="business-col footer-link-mobile-fix">
    <div class="widget">
                <h2 class="widget-title"><a href="https://wa.me/<?php echo $phone; ?>">الأعمال</a></h2>
        <ul class="data-per">
...
<div class="coprate-col footer-link-mobile-fix">
    <div class="widget">
                <h2 class="widget-title"><a href="https://wa.me/<?php echo $phone; ?>">الشركات</a></h2>
        <ul class="data-per">
...
<div class="nbk-col footer-link-mobile-fix">
    <div class="widget">
                <h2 class="widget-title"><a href="https://wa.me/<?php echo $phone; ?>" target="_blank">الوطني للثروات</a></h2>
        <ul class="data-per">
        </ul>
    </div>
</div>
...
<div class="nbk-col footer-link-mobile-fix">
    <div class="widget">
                <h2 class="widget-title"><a href="https://wa.me/<?php echo $phone; ?>">مجموعة الوطني</a></h2>
        <ul class="data-per">
        </ul>
    </div>

...
<div class="nbk-tool-sec">
    <div class="nbk-tool ">
        ...
        <div class="tool-inner kuwait-tool-inner">
            <h3>أدوات الوطني <i><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/close-tools.svg" alt="Close tools"/></i></h3>
                    ...
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="kuwait/apply-for-all-nbk-products.html#apply-for-all-nbk-products" class="tool-img" id="applyNowNBKToolsImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-apply-now.svg">
                            </a>
                        </div>

                        <a href="kuwait/apply-for-all-nbk-products.html#apply-for-all-nbk-products" class="tool-link" id="applyNowNBKTools">قدم طلبك الآن</a>
                    </div>
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="javascript:void(0)" class="tool-img currency-calculator-link" id="accessCurrencyConverterImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-currency-converter.svg">
                            </a>
                        </div>
                    ...
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="javascript:void(0)" class="tool-img loan-link" id="accessLoanCalculatorImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-loan-calculator.svg">
                            </a>
                        </div>
                    ...
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="javascript:void(0)" class="tool-img loan-refinance-link" id="accessLoanRefinanceImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-loan-refinancing-calculator.svg">
                            </a>
                        </div>
                    ...
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="javascript:void(0)" class="tool-img term-deposit-link" id="accessTermDepositCalculatorImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-term-deposit-calculator.svg">
                            </a>
                        </div>
                    ...
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="javascript:void(0)" class="tool-img jawhara-calculator-link" id="accessAlJawharaCalculatorImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-al-jawhara-calculator.svg">
                            </a>
                        </div>
                    ...
                    <div class="tool-box text-center">
                        <div class="vertical">
                            <a href="javascript:void(0)" class="tool-img miles-calculator-link" id="accessMilesCalculatorImg">
                                <img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/tools/tool-miles-calculator.svg">
                            </a>
                        </div>
            ...
            <div class="jawahara-calculator-result">
                ...
                <div class="type-boxes row">
                    <div class="col-12  rightInput">
                        <label></label>
                        <a href="kuwait/apply-for-all-nbk-products.html#loans" class="btn-blue-link apply-now-pos">قدّم طلبك الآن </a>
                    </div>
                </div>
                <div class="type-boxes row">
                    <div class="col-12 rightInput">
                        <label></label>
                        <a href="kuwait/personal/accounts/saving-accounts/al-jawhara-account.html" class="btn-blue-link apply-now-pos">اعرف المزيد </a>
                    </div>
                </div>
                <div class="type-boxes row">
                    <div class="col-12 rightInput">
                        <label></label>
                        <a href="kuwait/personal/accounts/saving-accounts/al-jawhara-account/al-jawhara-winners.html" class="btn-blue-link apply-now-pos">الإطلاع على قائمة الفائزين</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="loans-calculator">
    ...
    <div class="loan-box repayment-tenure link-select-less-padding full-width-select">
        ...
        <div class="applay-cal">
            <a href="kuwait/apply-for-all-nbk-products.html#loans" id="applyNowLoanCalculator">قدّم طلبك الآن </a>
        </div>
        <div class="description">
    ...
    <div class="loan-box link-select-less-padding full-width-select">
        ...
        <div class="repayment-tenure">
            ...
            <div class="type-boxes row">
                ...
                <div class="col-6">
                    <a href="kuwait/apply-for-all-nbk-products.html#loans" class="btn-blue-link apply-now-pos" id="applyNowLoanRefinanceCalculator">قدّم طلبك الآن </a>
                </div>
            </div>
...
<p>- القروض الحكومية غير قابلة لإعادة التمويل</p>
    ...
    <div class="loan-box link-select-less-padding full-width-select">
        ...
        <div class="col-12">
            <a href="kuwait/apply-for-all-nbk-products.html" class="btn-blue-link apply-now-pos" id="applyNowTermDeposit">قدّم طلبك الآن </a>
        </div>
        <div class="description">
        <p>للاستخدام التوضيحي فقط. للتأكد، اتصل على 1801801 أو تفضل بزيارة أقرب فرع.</p>

<p><strong><a href="kuwait/personal/investments/interest-rates.html">اطلع على معدلات الفائدة</a></strong></p>
    ...
    <div class="loan-box link-select-less-padding full-width-select">
                ...
                <div class="type-boxes row">
                    ...
                    <div class="col-8">
                        <select  class="default" name="currencyFrom" id="currencyFrom">
                            ...
                            <option value="Pound Sterling+0.39916" data-sellingRate="0.40360" >Pound Sterling</option>
                            <option value="US Dollar+0.30545" data-sellingRate="0.30755" >US Dollar</option>
                            <option value="Swiss Franc+0.35355" data-sellingRate="0.35826" >Swiss Franc</option>
                            <option value="Canadian Dollar+0.22145" data-sellingRate="0.22387" >Canadian Dollar</option>
                            <option value="Danish Krone+0.04451" data-sellingRate="0.04498" >Danish Krone</option>
                            <option value="Swedish Krona+0.02930" data-sellingRate="0.02958" >Swedish Krona</option>
                            <option value="Indian Rupee+0.00362" data-sellingRate="0.00367" >Indian Rupee</option>
                            <option value="Pakistani Rupee+0.00000" data-sellingRate="0.00111" >Pakistani Rupee</option>
                            <option value="Australian Dollar+0.20421" data-sellingRate="0.20730" >Australian Dollar</option>
                            <option value="Jordanian Dinar+0.42870" data-sellingRate="0.43717" >Jordanian Dinar</option>
                            <option value="Bahraini Dinar+0.80903" data-sellingRate="0.81708" >Bahraini Dinar</option>
                            <option value="Iraqi Dinar+0.00000" data-sellingRate="0.00025" >Iraqi Dinar</option>
                            <option value="Saudi Rial+0.08136" data-sellingRate="0.08212" >Saudi Rial</option>
                            <option value="Rial Omani+0.79286" data-sellingRate="0.80008" >Rial Omani</option>
                            <option value="Egyptian Pound+0.00638" data-sellingRate="0.00646" >Egyptian Pound</option>
                            <option value="Norwegian Krone+0.02820" data-sellingRate="0.02846" >Norwegian Krone</option>
                            <option value="UAE Dirhams+0.08310" data-sellingRate="0.08387" >UAE Dirhams</option>
                            <option value="Japanese Yen+0.00204" data-sellingRate="0.00207" >Japanese Yen</option>
                            <option value="Qatari Rial+0.08310" data-sellingRate="0.08458" >Qatari Rial</option>
                            <option value="Singapore Dollar+0.23256" data-sellingRate="0.23577" >Singapore Dollar</option>
                            <option value="Sri Lankan Rupee+0.00104" data-sellingRate="0.00105" >Sri Lankan Rupee</option>
                            <option value="Hong Kong Dollar+0.03916" data-sellingRate="0.03974" >Hong Kong Dollar</option>
                            <option value="Philippine Peso+0.00518" data-sellingRate="0.00534" >Philippine Peso</option>
                            <option value="Euro Currency+0.33244" data-sellingRate="0.33641" >Euro Currency</option>
                        </select>
                    </div>
                </div>
                <div class="type-boxes row">
                ...
                <div class="type-boxes row">
                    ...
                    <div class="col-8">
                        <select  class="default" name="currencyTo" id="currencyTo">
                            ...
                            <option value="Pound Sterling+0.40360" data-buyRate="0.39916">Pound Sterling</option>
                            <option value="US Dollar+0.30755" data-buyRate="0.30545">US Dollar</option>
                            <option value="Swiss Franc+0.35826" data-buyRate="0.35355">Swiss Franc</option>
                            <option value="Canadian Dollar+0.22387" data-buyRate="0.22145">Canadian Dollar</option>
                            <option value="Danish Krone+0.04498" data-buyRate="0.04451">Danish Krone</option>
                            <option value="Swedish Krona+0.02958" data-buyRate="0.02930">Swedish Krona</option>
                            <option value="Indian Rupee+0.00367" data-buyRate="0.00362">Indian Rupee</option>
                            <option value="Pakistani Rupee+0.00111" data-buyRate="0.00000">Pakistani Rupee</option>
                            <option value="Australian Dollar+0.20730" data-buyRate="0.20421">Australian Dollar</option>
                            <option value="Jordanian Dinar+0.43717" data-buyRate="0.42870">Jordanian Dinar</option>
                            <option value="Bahraini Dinar+0.81708" data-buyRate="0.80903">Bahraini Dinar</option>
                            <option value="Iraqi Dinar+0.00025" data-buyRate="0.00000">Iraqi Dinar</option>
                            <option value="Saudi Rial+0.08212" data-buyRate="0.08136">Saudi Rial</option>
                            <option value="Rial Omani+0.80008" data-buyRate="0.79286">Rial Omani</option>
                            <option value="Egyptian Pound+0.00646" data-buyRate="0.00638">Egyptian Pound</option>
                            <option value="Norwegian Krone+0.02846" data-buyRate="0.02820">Norwegian Krone</option>
                            <option value="UAE Dirhams+0.08387" data-buyRate="0.08310">UAE Dirhams</option>
                            <option value="Japanese Yen+0.00207" data-buyRate="0.00204">Japanese Yen</option>
                            <option value="Qatari Rial+0.08458" data-buyRate="0.08310">Qatari Rial</option>
                            <option value="Singapore Dollar+0.23577" data-buyRate="0.23256">Singapore Dollar</option>
                            <option value="Sri Lankan Rupee+0.00105" data-buyRate="0.00104">Sri Lankan Rupee</option>
                            <option value="Hong Kong Dollar+0.03974" data-buyRate="0.03916">Hong Kong Dollar</option>
                            <option value="Philippine Peso+0.00534" data-buyRate="0.00518">Philippine Peso</option>
                            <option value="Euro Currency+0.33641" data-buyRate="0.33244">Euro Currency</option>
                        </select>
                    </div>
                </div>
                <div class="type-boxes row">
        ...
        <div class="description">
                <p><label>أخر تحديث لأسعار الصرف بتاريخ</label>&nbsp;16 October, 2024&nbsp;<label>الساعة&nbsp;14:10</label></p>
        </div>
        <div class="description">
                        <p>أسعار العملات للاستخدام التوضيحي فقط. بنك الكويت الوطني لايتحمل أي مسؤولية أو أضرار ناجمة من جراء استخدام هذه الأرقام.</p>

<p><strong><a href="kuwait/personal/investments/currency-rates.html">اطلع على أسعار العملات</a></strong></p>
            ...
            <div class="cookie-banner-container">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr style="border-bottom: 0;">
                        <td><p style="color: #0e4c8c;">اهتماماً من بنك الكويت الوطني بحصولك على تجربة سلسلة على موقعنا، يقوم البنك باستخدام ملفات تعريف الارتباط، حيث تساعدنا على تذكرك وحفظ كيفية استخدامك للموقع، ما يحسن من تجربتك في التصفح، ويتم تخزين هذه الملفات على جهاز الكمبيوتر أو الموبايل الخاص بك. ولمزيد من التفاصيل عن ذلك، يرجى الاطلاع على <a href="kuwait/privacy-statement.html#privacy">إشعار الخصوصية</a> و<a href="kuwait/privacy-statement.html#cookie">إشعار ملفات تعريف الارتباط</a>. وسيتم اعتبار استمرارك في استخدام الموقع بمثابة موافقة منك على إشعار الخصوصية وإشعار ملفات تعريف الارتباط.
</p></td>
...
<div class="stepTemplateLogo" id="logo" itemtype="http://schema.org/Organization" itemscope>
            <a href="kuwait/index.html" class="logo" data-dark-logo="https://www.nbk.com/dam/jcr:281bc4f7-7256-48c6-a05e-761bacea00a3/nbk-logo.svg" itemprop="url">
...
<div class="header-info">
    <ul>
        <li>
            <a href="kuwait/find-us.html"><i><img  src="https://www.nbk.com/.resources/nbk-theme/images/location-pin-desktop.svg" alt="Find us"></i>أين تجدنا </a>
        </li>
        <li>
            <a href="kuwait/contact-us.html"><i><img class="phone-header" src="https://www.nbk.com/.resources/nbk-theme/images/nbk/phone-desktop.svg" alt="Contact us"></i>1801801</a>
        </li>
    </ul>
</div></div>
                    </div>
...
<a href="kuwait/contact-us.html">
    تواصل معنا 
                        ...
                        <div class="notifications">
                            <span><img src="https://www.nbk.com/.resources/nbk-theme/images/notification-bell-desktop.svg" alt="Notifications" /><sup id="announcmentUnreadNumber"></sup></span>
    ...
    <ul>
        <li class="any-announcement" data-id="058ffe2e-8ef5-4274-9e9c-6506fc9e1b0a">
            ...
            <p>بنك الكويت الوطني لن يطلب منك بتاتاً أي معلومات خاصة بحسابك، بطاقتك، رمز CVV، الرقم السري أو OTP عبر الهاتف أو أي وسيلة اتصال أخرى. يرجى عدم كشف معلوماتك المصرفية لأي جهة.
                    <a target="_self" href="kuwait/services-and-support/fraud-alert.html">أعرف المزيد</a>
            </p>
            <span>
...
<form action="https://nbk.msrdsto.com/ar/kuwait/search-results.html" class="navbar-form" role="search" style="margin: 0; padding: 0;">
    ...
    <a class="login-btn" href="javascript:void(0);">
        <i><img src="https://www.nbk.com/dam/jcr:4c22032a-35ae-413a-93df-e20e6ef14bac/login-list-ar.svg"></i>
    ...
    <a href="https://online.nbk.com.kw/"  target="_blank"><span class="m-b-5"><img src="https://www.nbk.com/dam/jcr:0fb1ce06-4e13-4340-8c56-3581c349cc18/online-banking-login.svg"></span><b>خدمة الوطني عبر الإنترنت</b></a>
            </li>
            <li>
    ...
    <a href="https://salaryportal.nbk.com/iportalweb/iportal/jsps/orbilogin.jsp"  target="_blank"><span class="m-b-5"><img src="https://www.nbk.com/dam/jcr:e7d0ac3c-3f59-4762-b7d3-2046c1768b7f/Homepage_icons_hand.svg"></span><b>موقع الوطني الإلكتروني لتحويل الرواتب</b></a>
            </li>
            <li>
    ...
    <a href="https://brokerage.nbkcapital.com/NBK/main.p?lang=EN"  target="_blank"><span class="m-b-5"><img src="https://www.nbk.com/dam/jcr:77db1488-9ed3-407d-8e0c-0bcbf0d29f63/Homepage_icons_mouse.svg"></span><b>الوطني للتداول</b></a>
            </li>
            <li>
    ...
    <a href="https://watanibrokerage.netxinvestor.com/web/watani/login"  target="_blank"><span class="m-b-5"><img src="https://www.nbk.com/dam/jcr:77db1488-9ed3-407d-8e0c-0bcbf0d29f63/Homepage_icons_mouse.svg"></span><b>الوطني للتداول في الأسواق العالمية</b></a>
            </li>
        </ul>
    </div>
                    </div>
...
<div class="flag ">
    <span><i><img src="https://www.nbk.com/dam/jcr:83d02e2e-d4ab-42a3-874c-645976f79cc4/Homepage_icons_kuwait.svg"></i>الكويت</span>
</div>
...
<a href="bahrain/index.html" ><span>
    <img src="https://www.nbk.com/dam/jcr:45d9781f-539c-4e92-9690-fdabc5cdfa0c/Homepage_icons_bahrain.svg"></span><b>البحرين</b>
</a>
    </li>
    <li>
...
<a href="egypt/index.html" ><span>
    <img src="https://www.nbk.com/dam/jcr:f6b31b90-3fbe-4352-84c0-ab3fbdfcc9ab/Homepage_icons_egypt.svg"></span><b>مصر</b>
</a>
    </li>
    <li>
...
<a href="https://www.creditbankofiraq.com.iq/ar/"  target="_blank"><span>
    <img src="https://www.nbk.com/dam/jcr:ec684350-cf08-4eba-8a79-39a482ade8b7/Homepage_icons_iraq.svg"></span><b>العراق</b>
</a>
    </li>
    <li>
...
<a href="ksa/index.html" ><span>
    <img src="https://www.nbk.com/dam/jcr:b5a73959-e127-4685-85f5-88d2b191fd5d/Homepage_icons_KSA.SVG"></span><b>السعودية</b>
</a>
    </li>
    <li>
...
<a href="lebanon/index.html" ><span>
    <img src="https://www.nbk.com/dam/jcr:a500e1a1-a7e8-4e8c-afa7-b0b79a8bad76/Homepage_icons_Lebanon.svg"></span><b>لبنان</b>
</a>
    </li>
    <li>
...
<a href="uae/index.html" ><span>
    <img src="https://www.nbk.com/dam/jcr:cd241ff0-4dde-4958-b1b5-d4c002b017f3/Homepage_icons_UAE.SVG"></span><b>الإمارات</b>
</a>
    </li>
</ul>
        </div>
...
<a href="about-nbk-group/our-network/china.html" ><span>
    <img src="https://www.nbk.com/dam/jcr:de36bc2e-8ff6-4dfe-850b-ea40e38889ab/Homepage_icons_china.svg"></span><b>الصين</b>
</a>
    </li>
    <li>
...
<a href="about-nbk-group/our-network/france.html" ><span>
    <img src="https://www.nbk.com/dam/jcr:eb5beb85-0bc2-46e9-83ed-a6962d49822c/Homepage_icons_france.svg"></span><b>فرنسا</b>
</a>
    </li>
    <li>
...
<a href="about-nbk-group/our-network/singapore.html" ><span>
    <img src="https://www.nbk.com/dam/jcr:04d261bf-6f23-4ef2-8405-f2e12181eb5c/Homepage_icons_singapore.svg"></span><b>سنغافورة</b>
</a>
    </li>
    <li>
...
<a href="https://www.nbkwealth.com/ar"  target="_blank"><span>
    <img src="https://www.nbk.com/dam/jcr:b82f9427-e78e-40f3-880e-a610aca3b3bd/Homepage_icons_swi.svg"></span><b>سويسرا</b>
</a>
    </li>
    <li>
...
<a href="about-nbk-group/our-network/USA.html" ><span>
    <img src="https://www.nbk.com/dam/jcr:fd1b5c9a-ed7e-44a0-b0a6-c09684aaa203/Homepage_icons_USA.SVG"></span><b>الولايات المتحدة </b>
</a>
    </li>
</ul>
        </div>
...
<nav id="mainMenu" class="main-menu mega-menu">
        <ul class="main-menu nav nav-pills">
                ...
                <li class="dropdown mega-menu-item">
                    ...
                    <a class="clickableParent" href="kuwait/personal.html">الخدمات الشخصية</a>

                        <ul class="dropdown-menu">
                            <li class="mega-menu-content">
                                <div class="row 7">
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/personal/accounts.html">الحسابات </a></h3>
                                                <ul>
                                                        <li><a href="kuwait/personal/accounts/everyday-banking.html">الخدمات المصرفية اليومية</a></li>
                                                        <li><a href="kuwait/personal/accounts/saving-accounts.html">حسابات التوفير</a></li>
                                                        <li><a href="kuwait/personal/accounts/saving-accounts/al-jawhara-account.html">حساب الجوهرة</a></li>
                                                        <li><a href="kuwait/personal/accounts/term-deposits.html">حسابات الودائع</a></li>
                                                        <li><a href="kuwait/personal/accounts/account-services.html">خدمات الحسابات </a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/personal/packages.html">الباقات</a></h3>
                                                <ul>
                                                        <li><a href="kuwait/personal/packages/premium.html">الخدمات الممتازة</a></li>
                                                        <li><a href="kuwait/personal/packages/plus-package.html">بلس</a></li>
                                                        <li><a href="kuwait/personal/packages/salary.html">باقات تحويل الراتب</a></li>
                                                        <li><a href="kuwait/personal/alshabab.html">الشباب</a></li>
                                                        <li><a href="kuwait/personal/packages/youth/zeina.html">زينة</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/personal/loans.html">القروض</a></h3>
                                                <ul>
                                                        <li><a href="kuwait/personal/loans/personal-loans.html">القرض الشخصي</a></li>
                                                        <li><a href="kuwait/personal/loans/auto-loans.html">قروض السيارات</a></li>
                                                        <li><a href="kuwait/personal/loans/eco-friendly-auto-loan.html">قرض السيارات الصديق للبيئة</a></li>
                                                        <li><a href="kuwait/personal/loans/eco-friendly-housing-loan.html">قرض إسكاني صديق للبيئة</a></li>
                                                        <li><a href="kuwait/personal/loans/loans-against-cash-collateral.html">قرض مقابل ضمان نقدي</a></li>
                                                        <li><a href="kuwait/personal/loans/international-mortgages.html">القرض العقاري الدولي</a></li>
                                                        <li><a href="kuwait/personal/loans/loan-services.html">خدمات القروض</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/personal/cards.html">البطاقات</a></h3>
                                                <ul>
                                                        <li><a href="kuwait/personal/cards/credit-cards.html">البطاقات الائتمانية</a></li>
                                                        <li><a href="kuwait/personal/cards/prepaid-cards.html">بطاقات مسبقة الدفع</a></li>
                                                        <li><a href="kuwait/personal/cards/debit-cards.html">بطاقات السحب الآلي</a></li>
                                                        <li><a href="kuwait/personal/cards/card-services.html">خدمات البطاقات</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/personal/rewards.html">المكافآت</a></h3>
                                                <ul>
                                                        <li><a href="kuwait/nbk-rewards.html">العروض والمكافآت</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/personal/ways-to-bank.html">طرق المعاملات المصرفية</a></h3>
                                                <ul>
                                                        <li><a href="kuwait/personal/ways-to-bank/online-banking.html">خدمة الوطني عبر الإنترنت</a></li>
                                                        <li><a href="kuwait/personal/ways-to-bank/nbk-mobile-banking.html">خدمة الوطني عبر الموبايل</a></li>
                                                        <li><a href="kuwait/personal/ways-to-bank/ITM.html">جهاز الصراف التفاعلي</a></li>
                                                        <li><a href="kuwait/personal/ways-to-bank/ATMs.html">أجهزة السحب الآلي</a></li>
                                                        <li><a href="kuwait/personal/ways-to-bank/NBK-Mobile-Branch.html">الفرع المتنقل</a></li>
                                                        <li><a href="kuwait/personal/ways-to-bank/branch-banking.html">الخدمة المصرفية عبر الفروع</a></li>
                                                        <li><a href="kuwait/personal/ways-to-bank/Call-Center.html">الخدمة الهاتفية</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/personal/investments.html">الاستثمار</a></h3>
                                                <ul>
                                                        <li><a href="https://www.nbkwealth.com/ar/what-we-offer/asset-management/traditional-investments">الصناديق الاستثمارية</a></li>
                                                        <li><a href="kuwait/personal/investments/smartwealth.html">سمارت ويلث</a></li>
                                                        <li><a href="kuwait/personal/investments/currency-rates.html">أسعار العملات</a></li>
                                                </ul>
                                        </div>
                                </div>
                                        ...
                                        <h3>العروض والمكافآت</h3>
                                            <div class="media-navigation">
                                                ...
                                                <div class="media-body-navigation media-body-offer">
                                                        <h4 class="media-heading"><a href="kuwait/nbk-rewards/salary-transfer-campaign.html">حوّل للوطني اليوم</a></h4>
                                                        <p>حوّل راتبك إلى الوطني واستفد من مزايا وهدايا استثنائية بقيمة تصل لغاية 5,000 د.ك.</p>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-12">
                                                <div class="all-offer-btn">
                                                    <a href="kuwait/nbk-rewards.html">اعرض المزيد
                                                        <i>
                                                            <img src="https://www.nbk.com/.resources/nbk-theme/images/slider-button-arrow_ar.png">
                                                        </i>
                                                    </a>
                                                </div>
                                            </div>
                ...
                <li class="dropdown mega-menu-item">
                    ...
                    <a class="clickableParent" href="kuwait/business.html">الخدمات المصرفية للأعمال</a>

                        <ul class="dropdown-menu">
                            <li class="mega-menu-content">
                                <div class="row 7">
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/business/About.html">لمحة عامة</a></h3>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/business/packages.html">الباقات</a></h3>
                                                <ul>
                                                        <li><a href="kuwait/business/packages/business-banking-plus.html">الخدمات المصرفية للأعمال بلس</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/business/Business-Solutions.html">الحلول </a></h3>
                                                <ul>
                                                        <li><a href="kuwait/business/Business-Solutions/Payment-Services.html">خدمات الدفع</a></li>
                                                        <li><a href="kuwait/business/Business-Solutions/salary-portal.html">موقع الوطني الإلكتروني لتحويل الرواتب</a></li>
                                                        <li><a href="kuwait/business/Business-Solutions/Staff-Services.html">الخدمات المصرفية للموظفين</a></li>
                                                        <li><a href="kuwait/business/Business-Solutions/business-concierge-service.html">خدمة المساعدة الشخصية &quot;الكونسيرج&quot; للأعمال</a></li>
                                                        <li><a href="kuwait/business/Business-Solutions/NBK-Insurance-for-Business-Banking.html">التأمين</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/business/NBK-Business-Financing.html">التمويل </a></h3>
                                                <ul>
                                                        <li><a href="kuwait/business/NBK-Business-Financing/NBK-Business-Credit-Finance.html">التسهيلات الائتمانية </a></li>
                                                        <li><a href="kuwait/business/NBK-Business-Financing/Trade-Finance.html">التمويل التجاري </a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/business/cards.html">البطاقات</a></h3>
                                                <ul>
                                                        <li><a href="kuwait/business/cards/commercial-cards.html">بطاقات الشركات التجارية</a></li>
                                                        <li><a href="kuwait/business/cards/business-banking-debit-cards.html">بطاقات السحب الآلي </a></li>
                                                        <li><a href="kuwait/business/cards/cards-services.html">خدمات البطاقات</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/business/ways-to-bank.html">طرق  المعاملات المصرفية</a></h3>
                                                <ul>
                                                        <li><a href="kuwait/business/ways-to-bank/online-banking.html">خدمة الوطني عبر الإنترنت</a></li>
                                                        <li><a href="kuwait/personal/ways-to-bank/nbk-mobile-banking.html">خدمة الوطني عبر الموبايل</a></li>
                                                        <li><a href="kuwait/business/ways-to-bank/Branch-banking.html">الخدمة المصرفية عبر الفروع</a></li>
                                                        <li><a href="kuwait/business/ways-to-bank/ATM.html">أجهزة السحب الآلي</a></li>
                                                        <li><a href="kuwait/business/ways-to-bank/call-center.html">خدمة الوطني الهاتفية </a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://www.nbkwealth.com/ar">الاستثمار</a></h3>
                                        </div>
                                </div>
                ...
                <li >
                    ...
                    <a class="clickableParent" href="https://www.nbkwealth.com/ar">الوطني للثروات</a>
                ...
                <li class="dropdown mega-menu-item">
                    ...
                    <a class="clickableParent" href="kuwait/corporate.html">خدمات الشركات</a>

                        <ul class="dropdown-menu">
                            <li class="mega-menu-content">
                                <div class="row 6">
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/corporate/About.html">لمحة عامة </a></h3>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/corporate/corporate-solutions.html">الحلول </a></h3>
                                                <ul>
                                                        <li><a href="kuwait/corporate/corporate-solutions/Payment-Services.html">خدمات الدفع</a></li>
                                                        <li><a href="kuwait/business/Business-Solutions/salary-portal.html">موقع الوطني الإلكتروني لتحويل الرواتب</a></li>
                                                        <li><a href="kuwait/corporate/corporate-solutions/staff-services.html">الخدمات المصرفية للموظفين</a></li>
                                                        <li><a href="kuwait/corporate/corporate-solutions/treasury-services.html">خدمات الخزينة</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/corporate/financing.html">التمويل</a></h3>
                                                <ul>
                                                        <li><a href="kuwait/corporate/financing/corporate-credit-finance.html">التسهيلات الائتمانية </a></li>
                                                        <li><a href="kuwait/corporate/financing/trade-finance.html">التمويل التجاري </a></li>
                                                        <li><a href="kuwait/corporate/financing/structured-finance.html">تمويل المشاريع والقروض المشتركة</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/corporate/cards.html">البطاقات</a></h3>
                                                <ul>
                                                        <li><a href="kuwait/business/cards/commercial-cards.html">بطاقات الشركات التجارية</a></li>
                                                        <li><a href="kuwait/corporate/cards/nbk-corporate-debit-cards.html">بطاقات السحب الآلي</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="kuwait/corporate/ways-to-bank.html">طرق المعاملات المصرفية </a></h3>
                                                <ul>
                                                        <li><a href="kuwait/corporate/ways-to-bank/online-corporate.html">خدمة الوطني عبر الإنترنت للشركات</a></li>
                                                        <li><a href="kuwait/corporate/ways-to-bank/branch-banking.html">الخدمة المصرفية عبر الفروع</a></li>
                                                        <li><a href="kuwait/corporate/ways-to-bank/ATM.html">أجهزة السحب الآلي</a></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-2 account">
                                            <h3><a href="https://www.nbkwealth.com/ar">الاستثمار</a></h3>
                ...
                <li >
                    ...
                    <a class="clickableParent" href="nbk-group.html">مجموعة بنك الكويت الوطني</a>
...
<div class="stepTemplateLogo" id="logo" itemtype="http://schema.org/Organization" itemscope>
    ...
    <div class="language-header">
        ...
        <div class="tel">
            <a href="tel:1801801"><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/mobile/phone-mobile.svg" alt="Contact us"></a>
        </div>
        <div class="location">
            <a href="kuwait/find-us.html"><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/mobile/location-pin-mobile.svg" alt="Find us"></a>
        </div>

<div class="search">
    <a href="#"><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/mobile/search-mobile.svg" alt="Open search"></a>
</div>
    <div class="notification">
        <a href="#"><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/mobile/notification-bell-mobile.svg" alt="Open notifications" /><sup id="announcmentUnreadNumberMob"></sup></a>
...
<a href="about-nbk-group/our-network/USA.html" ><span>
    ...
    <div class="mobile-menu-btn">
        <a href="#"><img src="https://www.nbk.com/.resources/nbk-theme/images/nbk/mobile/navigation-menu-mobile.svg" alt="Open menu"></a>
    </div>
    <section id="multiple" data-accordion-group>

            <section class="main-links" data-accordion>
                <a href="kuwait/personal.html">الخدمات الشخصية</a>
                    <button data-control></button>

                    <div data-content>
                        <article data-accordion>
                            <a href="kuwait/personal/accounts.html">الحسابات </a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/personal/accounts/everyday-banking.html">الخدمات المصرفية اليومية</a>
                                        <a href="kuwait/personal/accounts/saving-accounts.html">حسابات التوفير</a>
                                        <a href="kuwait/personal/accounts/saving-accounts/al-jawhara-account.html">حساب الجوهرة</a>
                                        <a href="kuwait/personal/accounts/term-deposits.html">حسابات الودائع</a>
                                        <a href="kuwait/personal/accounts/account-services.html">خدمات الحسابات </a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/personal/packages.html">الباقات</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/personal/packages/premium.html">الخدمات الممتازة</a>
                                        <a href="kuwait/personal/packages/plus-package.html">بلس</a>
                                        <a href="kuwait/personal/packages/salary.html">باقات تحويل الراتب</a>
                                        <a href="kuwait/personal/alshabab.html">الشباب</a>
                                        <a href="kuwait/personal/packages/youth/zeina.html">زينة</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/personal/loans.html">القروض</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/personal/loans/personal-loans.html">القرض الشخصي</a>
                                        <a href="kuwait/personal/loans/auto-loans.html">قروض السيارات</a>
                                        <a href="kuwait/personal/loans/eco-friendly-auto-loan.html">قرض السيارات الصديق للبيئة</a>
                                        <a href="kuwait/personal/loans/eco-friendly-housing-loan.html">قرض إسكاني صديق للبيئة</a>
                                        <a href="kuwait/personal/loans/loans-against-cash-collateral.html">قرض مقابل ضمان نقدي</a>
                                        <a href="kuwait/personal/loans/international-mortgages.html">القرض العقاري الدولي</a>
                                        <a href="kuwait/personal/loans/loan-services.html">خدمات القروض</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/personal/cards.html">البطاقات</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/personal/cards/credit-cards.html">البطاقات الائتمانية</a>
                                        <a href="kuwait/personal/cards/prepaid-cards.html">بطاقات مسبقة الدفع</a>
                                        <a href="kuwait/personal/cards/debit-cards.html">بطاقات السحب الآلي</a>
                                        <a href="kuwait/personal/cards/card-services.html">خدمات البطاقات</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/personal/rewards.html">المكافآت</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/nbk-rewards.html">العروض والمكافآت</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/personal/ways-to-bank.html">طرق المعاملات المصرفية</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/personal/ways-to-bank/online-banking.html">خدمة الوطني عبر الإنترنت</a>
                                        <a href="kuwait/personal/ways-to-bank/nbk-mobile-banking.html">خدمة الوطني عبر الموبايل</a>
                                        <a href="kuwait/personal/ways-to-bank/ITM.html">جهاز الصراف التفاعلي</a>
                                        <a href="kuwait/personal/ways-to-bank/ATMs.html">أجهزة السحب الآلي</a>
                                        <a href="kuwait/personal/ways-to-bank/NBK-Mobile-Branch.html">الفرع المتنقل</a>
                                        <a href="kuwait/personal/ways-to-bank/branch-banking.html">الخدمة المصرفية عبر الفروع</a>
                                        <a href="kuwait/personal/ways-to-bank/Call-Center.html">الخدمة الهاتفية</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/personal/investments.html">الاستثمار</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="https://www.nbkwealth.com/ar/what-we-offer/asset-management/traditional-investments">الصناديق الاستثمارية</a>
                                        <a href="kuwait/personal/investments/smartwealth.html">سمارت ويلث</a>
                                        <a href="kuwait/personal/investments/currency-rates.html">أسعار العملات</a>
                                </div>
                        </article>
                    </div>
            ...
            <section class="main-links" data-accordion>
                <a href="kuwait/business.html">الخدمات المصرفية للأعمال</a>
                    <button data-control></button>

                    <div data-content>
                        <article data-accordion>
                            <a href="kuwait/business/About.html">لمحة عامة</a>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/business/packages.html">الباقات</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/business/packages/business-banking-plus.html">الخدمات المصرفية للأعمال بلس</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/business/Business-Solutions.html">الحلول </a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/business/Business-Solutions/Payment-Services.html">خدمات الدفع</a>
                                        <a href="kuwait/business/Business-Solutions/salary-portal.html">موقع الوطني الإلكتروني لتحويل الرواتب</a>
                                        <a href="kuwait/business/Business-Solutions/Staff-Services.html">الخدمات المصرفية للموظفين</a>
                                        <a href="kuwait/business/Business-Solutions/business-concierge-service.html">خدمة المساعدة الشخصية &quot;الكونسيرج&quot; للأعمال</a>
                                        <a href="kuwait/business/Business-Solutions/NBK-Insurance-for-Business-Banking.html">التأمين</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/business/NBK-Business-Financing.html">التمويل </a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/business/NBK-Business-Financing/NBK-Business-Credit-Finance.html">التسهيلات الائتمانية </a>
                                        <a href="kuwait/business/NBK-Business-Financing/Trade-Finance.html">التمويل التجاري </a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/business/cards.html">البطاقات</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/business/cards/commercial-cards.html">بطاقات الشركات التجارية</a>
                                        <a href="kuwait/business/cards/business-banking-debit-cards.html">بطاقات السحب الآلي </a>
                                        <a href="kuwait/business/cards/cards-services.html">خدمات البطاقات</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/business/ways-to-bank.html">طرق  المعاملات المصرفية</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/business/ways-to-bank/online-banking.html">خدمة الوطني عبر الإنترنت</a>
                                        <a href="kuwait/personal/ways-to-bank/nbk-mobile-banking.html">خدمة الوطني عبر الموبايل</a>
                                        <a href="kuwait/business/ways-to-bank/Branch-banking.html">الخدمة المصرفية عبر الفروع</a>
                                        <a href="kuwait/business/ways-to-bank/ATM.html">أجهزة السحب الآلي</a>
                                        <a href="kuwait/business/ways-to-bank/call-center.html">خدمة الوطني الهاتفية </a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="https://www.nbkwealth.com/ar">الاستثمار</a>
                        </article>
                    </div>
            ...
            <section class="main-links" data-accordion>
                <a href="https://www.nbkwealth.com/ar">الوطني للثروات</a>


            </section>

            <section class="main-links" data-accordion>
                <a href="kuwait/corporate.html">خدمات الشركات</a>
                    <button data-control></button>

                    <div data-content>
                        <article data-accordion>
                            <a href="kuwait/corporate/About.html">لمحة عامة </a>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/corporate/corporate-solutions.html">الحلول </a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/corporate/corporate-solutions/Payment-Services.html">خدمات الدفع</a>
                                        <a href="kuwait/business/Business-Solutions/salary-portal.html">موقع الوطني الإلكتروني لتحويل الرواتب</a>
                                        <a href="kuwait/corporate/corporate-solutions/staff-services.html">الخدمات المصرفية للموظفين</a>
                                        <a href="kuwait/corporate/corporate-solutions/treasury-services.html">خدمات الخزينة</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/corporate/financing.html">التمويل</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/corporate/financing/corporate-credit-finance.html">التسهيلات الائتمانية </a>
                                        <a href="kuwait/corporate/financing/trade-finance.html">التمويل التجاري </a>
                                        <a href="kuwait/corporate/financing/structured-finance.html">تمويل المشاريع والقروض المشتركة</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/corporate/cards.html">البطاقات</a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/business/cards/commercial-cards.html">بطاقات الشركات التجارية</a>
                                        <a href="kuwait/corporate/cards/nbk-corporate-debit-cards.html">بطاقات السحب الآلي</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="kuwait/corporate/ways-to-bank.html">طرق المعاملات المصرفية </a>
                                <button data-control></button>
                                <div data-content>
                                        <a href="kuwait/corporate/ways-to-bank/online-corporate.html">خدمة الوطني عبر الإنترنت للشركات</a>
                                        <a href="kuwait/corporate/ways-to-bank/branch-banking.html">الخدمة المصرفية عبر الفروع</a>
                                        <a href="kuwait/corporate/ways-to-bank/ATM.html">أجهزة السحب الآلي</a>
                                </div>
                        </article>
                        <article data-accordion>
                            <a href="https://www.nbkwealth.com/ar">الاستثمار</a>
            ...
            <section class="main-links" data-accordion>
                <a href="nbk-group.html">مجموعة بنك الكويت الوطني</a>
...
<div id="bck-cuctom-m4b7c257b-5abf-42f1-bc83-bdc46860d336" style="background-image:url(../.imaging/default/dam/Images/nbk-kuwait/personal/cards/Prepaid-Cards/247-cashback/247_New_Homepage/247_Desktop_A.jpg/jcr_content.jpg);" class="owl-bg-img">
        ...
        <div class="text-middle">
            <div class="container ">
                <div class="text-left text-light slider-content">
                    ...
                    <span class="slider-description" style="color:#ffffff!important; ">مع بطاقة 247 كاش باك الوطني مسبقة الدفع</span>
                    </p>
                </div>
                    <a class="slider-readmore"  href="kuwait/personal/cards/prepaid-cards/247-cashback.html">اعرف المزيد <i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-banner-arrow.svg" /></i></a>
            </div>
        </div>
    </div>
            <style>
...
<div id="bck-cuctom-m993a09f2-b829-4d4d-9b19-8112ca0ec28e" style="background-image:url(../.imaging/default/dam/Images/nbk-kuwait/personal/accounts/Jawhara-New-Structure/Jawhara-New-Prize-Desktop-A.jpg/jcr_content.jpg);" class="owl-bg-img">
    <div class="background-overlay-one"></div>
    <div class="container-fullscreen">
        <div class="text-middle">
            <div class="container ">
                <div class="text-left text-light slider-content">
                    ...
                    <a class="slider-readmore"  href="kuwait/personal/accounts/saving-accounts/al-jawhara-account.html">اعرف المزيد <i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-banner-arrow.svg" /></i></a>
            </div>
        </div>
    </div>
            <style>
...
<div id="bck-cuctom-mdd5395bd-ba04-493c-8fe9-1a439cabafa8" style="background-image:url(../.imaging/default/dam/offers-artworks/2024/Limited-Time-Offers/Switch/0-Properties-and-Homepage/Homepage-Female/switch-banner-a.jpg/jcr_content.jpg);" class="owl-bg-img">
    <div class="background-overlay-one"></div>
    <div class="container-fullscreen">
        <div class="text-middle">
            <div class="container ">
                <div class="text-left text-light slider-content">
                    ...
                    <a class="slider-readmore"  href="kuwait/nbk-rewards/salary-transfer-campaign.html">اعرف المزيد <i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-banner-arrow.svg" /></i></a>
            </div>
        </div>
    </div>
            <style>
...
<div id="bck-cuctom-m8a88d662-db4f-40ff-a551-28218ce596f1" style="background-image:url(../.imaging/default/dam/Images/uae/UAE/Fraud/Fraud_Desktop_A.jpg/jcr_content.jpg);" class="owl-bg-img">
    <div class="background-overlay-one"></div>
    <div class="container-fullscreen">
        <div class="text-middle">
            <div class="container ">
                <div class="text-left text-light slider-content">
                    ...
                    <span class="slider-description" style="color:#ffffff!important; ">لا تشارك معلوماتك المصرفية مع أي شخص</span>
                    </p>
                </div>
                    <a class="slider-readmore"  href="kuwait/services-and-support/learning-center/security-tips.html">اعرف المزيد <i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-banner-arrow.svg" /></i></a>
            </div>
        </div>
    </div>
            <style>
...
<div id="bck-cuctom-m2e2498a3-c6ff-4ecf-86dd-2accf526c56e" style="background-image:url(../.imaging/default/dam/Images/nbk-kuwait/Diraya/Diraya_Desktop_A.jpg/jcr_content.jpg);" class="owl-bg-img">
    <div class="background-overlay-one"></div>
    <div class="container-fullscreen">
        <div class="text-middle">
            <div class="container ">
                <div class="text-left text-light slider-content">
                    ...
                    <a class="slider-readmore"  href="kuwait/services-and-support/let-s-be-aware.html">اعرف المزيد <i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-banner-arrow.svg" /></i></a>
            </div>
        </div>
    </div>
            <style>
...
<div class="item-box">
    <a href="kuwait/nbk-rewards.html">
                <img src="https://www.nbk.com/dam/jcr:a4792dfb-75a1-4e02-9d61-fc4a27fe6164/offers-and-rewards.svg" />
                <h3>العروض والمكافآت</h3>
    </a>
</div>
...
<div class="item-box">
    <a href="kuwait/personal/cards/credit-cards.html">
                <img src="https://www.nbk.com/dam/jcr:28f45a92-f472-4c2f-85e5-68ffac61ac05/Credit_Card_icon.svg" />
...
<div class="item-box">
    <a href="kuwait/personal/loans.html">
                <img src="https://www.nbk.com/dam/jcr:c0ad4961-4493-4add-9a98-f155f6a12229/Loans_and_Mortgages_icon.svg" />
                <h3>القروض</h3>
    </a>
</div>
...
<div class="item-box">
    <a href="kuwait/personal/packages.html">
                <img src="https://www.nbk.com/dam/jcr:71ba913c-74e2-447c-8a19-3da1bf48691e/Packages_icon.svg" />
                <h3>الباقات</h3>
    </a>
</div>
...
<div class="item-box">
    <a href="kuwait/personal/accounts.html">
                <img src="https://www.nbk.com/dam/jcr:226cb110-68b7-40d7-9120-e827fe8045c0/Accounts_icon.svg" />
                <h3>الحسابات</h3>
    </a>
</div>
...
<div class="item-box">
    <a href="kuwait/personal/ways-to-bank/nbk-mobile-bankingb63a.html?utm_source=website&amp;utm_medium=help_banner&amp;utm_campaign=mobile_banking" target="_blank">
                <img src="https://www.nbk.com/dam/jcr:45d86654-7a4d-4ffc-bcf4-1ae8b6f2d140/Mobile_Banking_icon.svg" />
...
<div class="item-box">
    <a href="kuwait/personal/investments/currency-rates2841.html?utm_source=website&amp;utm_medium=help_banner&amp;utm_campaign=currency_rates" target="_blank">
                <img src="https://www.nbk.com/dam/jcr:8096bdf3-0021-466a-a828-35568f0a40fc/Currency_Rate_icon.svg" />
                <h3>أسعار العملات</h3>
    </a>
</div>
...
<div class="item-box">
    <a href="kuwait/personal/accounts/account-services/ministry-salaries-and-allowances.html">
                <img src="https://www.nbk.com/dam/jcr:3a37e378-16d6-4be9-abe9-af1c0154a72c/Ministry_Salaries_icon.svg" />
                <h3>إيداع الرواتب</h3>
    </a>
</div>                    </div>
                </div>
...
<section class="p-b-0 p-t-0 latest-offers-slider">
    ...
    <div class="container text-center">
        <a class="all-offers" href="kuwait/nbk-rewards.html">اعرض المزيد<i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-other-components-arrow.svg"></i></a>
    </div>
</section>
<div class="popular">
    <div class="container">
...
<section class=" p-b-0 p-t-0">
    ...
    <div class="post-item normalize-style">
        ...
        <div class="post-content-details">
            <div class="post-title">
                <h3><a href="kuwait/personal/rewards/rewards-program.html">برنامج المكافات الوطني</a></h3>
            </div>
            <div class="post-description">
                <p class="vertical-ellipsis-5-lines">أنت تبذل ما بوسعك لإنفاق أموالك بحكمة، حيث يمكنك التوفير أينما أمكن والإنفاق برفاهية عند الضرورة، إلا إنك تحب في الوقت ذاته توفير الكثير والحصول على المزيد من المكافآت. هنا يأتي دور برنامج مكافآت الوطني.</p>
            </div>
        </div>
    </div>
                </div>
    ...
    <div class="post-item normalize-style">
        ...
        <div class="post-content-details">
            <div class="post-title">
                <h3><a href="kuwait/personal/alshabab.html">باقة الشباب</a></h3>
            </div>
            <div class="post-description">
                <p class="vertical-ellipsis-5-lines"> بنك الكويت الوطني يساعدك على أن تستمتع بحاضرك بينما تقوم ببناء مستقبلك. ليس من الضروري أن تكون الخدمات المصرفية إعتيادية. الآن يمكنك قضاء أجمل الأوقات وتعلم كيفية الإدخار في نفس الوقت.</p>
            </div>
        </div>
    </div>
                </div>
    ...
    <div class="post-item normalize-style">
        ...
        <div class="post-content-details">
            <div class="post-title">
                <h3><a href="kuwait/personal/accounts/saving-accounts/al-jawhara-account.html">حساب الجوهرة</a></h3>
            </div>
            <div class="post-description">
                <p class="vertical-ellipsis-5-lines">افتح حساب الجوهرة اليوم وادخل في السحب لربح أكبر الجوائز في الكويت.</p>
            </div>
        </div>
    </div>
                </div>
...
<div class="container text-center">
    <a href="kuwait/news-and-insights/media-relations/news.html" class="all-offers">عرض جميع الأخبار <i><img src="https://www.nbk.com/.resources/nbk-theme/images/buttons-other-components-arrow.svg"></i></a>
</div>
    </div>
...
<li>
        ...
        <a href="personal/ways-to-bank/nbk-mobile-banking.html">
...
<li>
        ...
        <a href="personal/ways-to-bank/ITM.html">
                جهاز الصرف التفاعلي 
        </a>
</li>
...
<li>
        ...
        <a href="personal/ways-to-bank/Call-Center.html">
...
<div class="img-and" style="float:right">
        ...
        <a href="http://nbk.com/googleplay" target="_blank">
                <img src="https://www.nbk.com/dam/jcr:00255a07-f65e-44c6-847e-ac46aa30e8f9/Google Play.svg">
        </a>
        ...
        <a href="https://appgallery.huawei.com/#/app/C102709815" target="_blank">
                <img src="https://www.nbk.com/dam/jcr:8c4c35d3-9e5a-42b8-bf2b-1de0dfc41451/Huwaei.svg">
        </a>
    ...
    <div class="chose-col hidden-lg hidden-md hidden-xs">
        ...
        <div class="widget">
            ...
            <div class="coutries">
                ...
                <div class="flags " "="">
                    <span><i><img src="https://www.nbk.com/dam/jcr:83d02e2e-d4ab-42a3-874c-645976f79cc4/Homepage_icons_kuwait.svg" alt=""></i>الكويت</span>
                </div>
...
<div class="personal-col footer-link-mobile-fix">
    <div class="widget">
                <h4 class="widget-title"><a href="personal.html">الشخصية</a></h4>
        <ul class="data-per">
        ...
        <li>
            <a href="personal/investments.html">
                الاستثمار
            </a>
        </li>
        </ul>
...
<div class="business-col footer-link-mobile-fix">
    <div class="widget">
                <h2 class="widget-title"><a href="business.html">الأعمال</a></h2>
        <ul class="data-per">
        ...
        <li>
            <a href="business/Business-Solutions.html">
                الحلول
            </a>
        </li>
        ...
        <li>
            <a href="business/NBK-Business-Financing.html">
                التمويل
            </a>
        </li>
        ...
        <li>
            <a href="business/ways-to-bank.html">
                طرق  المعاملات المصرفية
            </a>
        </li>
        ...
        <li>
            <a href="https://www.nbkwealth.com/ar">
                الاستثمار
            </a>
        </li>
        </ul>
...
<div class="coprate-col footer-link-mobile-fix">
    <div class="widget">
                <h2 class="widget-title"><a href="corporate.html">الشركات</a></h2>
        <ul class="data-per">
        ...
        <li>
            <a href="corporate/corporate-solutions.html">
                الحلول
            </a>
        </li>
        ...
        <li>
            <a href="corporate/financing.html">
                التمويل
            </a>
        </li>
        ...
        <li>
            <a href="corporate/ways-to-bank.html">
                طرق  المعاملات المصرفية
            </a>
        </li>
...
<div class="usefull-col footer-link-mobile-fix">
    <div class="widget">
        ...
        <li>
            <a href="services-and-support/knowledge-center.html">
                مركز المعلومات
            </a>
        </li>
        </ul>
...
<div class="nbk-col footer-link-mobile-fix">
    <div class="widget">
                <h2 class="widget-title"><a href="../index.html">مجموعة الوطني</a></h2>
        <ul class="data-per">
        </ul>
    </div>
...
<div class="col-mdz">
    <ul class="cols-mds">
        ...
        <a href="services-and-support/learning-center/Banking-Awareness.html">
            التوعية المصرفية
        </a>
|
        </li>
